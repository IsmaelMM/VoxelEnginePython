...
def builder_chunk_mesh(chunk_voxels, format_size):
    ...
    for x in range(CHUNK_SIZE):
        for y in range(CHUNK_SIZE):
            for z in range(CHUNK_SIZE):
                ...
                if is_void((x, y - 1, z), chunk_voxels):
                    # format: x, y, z, voxel_id, face_id
                    v0 = (x    , y + 1, z    , voxel_id, 1)
                    v1 = (x + 1, y + 1, z    , voxel_id, 1)
                    v2 = (x + 1, y + 1, z + 1, voxel_id, 1)
                    v3 = (x    , y + 1, z + 1, voxel_id, 1)
                ...
                if is_void((x - 1, y, z), chunk_voxels):
                    ...
                    v1 = (x + 1, y + 1, z    , voxel_id, 3)
                    v2 = (x + 1, y + 1, z + 1, voxel_id, 3)
                ...
                if is_void((x, y, z - 1), chunk_voxels):
                    # format: x, y, z, voxel_id, face_id
                    v0 = (x    , y + 1, z    , voxel_id, 4)
                    v1 = (x + 1, y + 1, z    , voxel_id, 4)
                    v2 = (x + 1, y + 1, z + 1, voxel_id, 4)
                    v3 = (x    , y + 1, z + 1, voxel_id, 4)
                ...
                if is_void((x, y, z + 1), chunk_voxels):
                    # format: x, y, z, voxel_id, face_id
                    v0 = (x    , y + 1, z    , voxel_id, 5)
                    v1 = (x + 1, y + 1, z    , voxel_id, 5)
                    v2 = (x + 1, y + 1, z + 1, voxel_id, 5)
                    v3 = (x    , y + 1, z + 1, voxel_id, 5)
